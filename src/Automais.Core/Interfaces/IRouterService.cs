...
public interface IRouterService
{
    ...
    Task<RouterDto> CreateAsync(Guid tenantId, CreateRouterDto dto, string apiUsername, string apiPasswordTemporaria, CancellationToken cancellationToken = default);
