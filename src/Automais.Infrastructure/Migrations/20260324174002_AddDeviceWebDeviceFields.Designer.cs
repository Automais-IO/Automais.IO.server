...
namespace Automais.Infrastructure.Migrations
{
    ...
    [Migration("20260324174002_AddDeviceWebDeviceFields")]
    partial class AddDeviceWebDeviceFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Automais.Core.Entities.AllowedNetwork", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VpnPeerId", "NetworkCidr")
                        .IsUnique();

                    b.ToTable("allowed_networks", "public");
                });
            ...
            modelBuilder.Entity("Automais.Core.Entities.Device", b =>
                {
                    ...
                    b.Property<bool>("WebDeviceEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("WebDeviceTokenHash")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("Automais.Core.Entities.Host", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LastMetricsAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastSeenAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastSshInteractiveReportAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("RemoteDisplayEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("RemoteDisplayPort")
                        .HasColumnType("integer");

                    b.Property<bool>("RemoteDisplayUseBootstrapCredentials")
                        .HasColumnType("boolean");

                    b.Property<string>("SetupCompletionToken")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<DateTime?>("SetupRequestedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("SshInteractiveSessionOpen")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("SshInteractiveSessionSince")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("SshPasswordHash")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Automais.Core.Entities.RemoteNetwork", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("remote_networks", "public");
                });
            ...
            modelBuilder.Entity("Automais.Core.Entities.Router", b =>
                {
                    ...
                    b.Property<string>("ApiPasswordTemporaria")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<DateTime?>("RouterOsApiAuthCheckedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("RouterOsApiAuthMessage")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<int>("RouterOsApiAuthStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Automais.Core.Entities.StaticNetwork", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VpnPeerId", "Destination")
                        .IsUnique();

                    b.ToTable("static_networks", "public");
                });
            ...
            modelBuilder.Entity("Automais.Core.Entities.TenantUser", b =>
                {
                    ...
                    b.Property<string>("EmailDeliveryFailureMessage")
                        .HasMaxLength(2000)
            ...
            modelBuilder.Entity("Automais.Core.Entities.UserAllowedRoute", b =>
                {
                    ...
                    b.Property<Guid>("AllowedNetworkId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AllowedNetworkId");

                    b.HasIndex("RouterId");

                    b.HasIndex("UserId");

                    b.HasIndex("UserId", "AllowedNetworkId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Automais.Core.Entities.VpnPeer", b =>
                {
                    ...
                    b.Property<bool?>("ReachableViaVpn")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Automais.Core.Entities.UserAllowedRoute", b =>
                {
                    b.HasOne("Automais.Core.Entities.AllowedNetwork", "AllowedNetwork")
                        .WithMany()
                        .HasForeignKey("AllowedNetworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Automais.Core.Entities.VpnPeer", b =>
                {
                    ...
                    b.Navigation("RemoteNetworks");

                    b.Navigation("StaticNetworks");
                });
